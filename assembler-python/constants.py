INSTRUCTIONS_TYPE = ['TYPE_R', 'TYPE_I', 'TYPE_S', 'TYPE_B', 'TYPE_U', 'TYPE_J']
...
PSEUDO_INSTRUCTIONS = ['la', 'li', 'nop', 'mv', 'not', 'neg', 'seqz', 'snez', 'sltz', 'sgtz', 'beqz', 'bnez', 'blez', 'bgez', 'bltz', 'bgtz', 'bgt', 'ble', 'bgtu', 'bleu', 'j', 'jr', 'ret', 'call', 'tail']
